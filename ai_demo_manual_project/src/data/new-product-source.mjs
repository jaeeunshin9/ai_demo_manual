export const newProductSource = {
  ...
  documentName: "New Product 사용자 매뉴얼",
  ...
  audience: "추후 업데이트 예정",
  productSummary:
    "New Product는 현재 문서 온보딩 준비 중인 신규 시스템입니다. 상세 내용은 추후 업데이트 예정입니다.",
  structuredFacts: [
    "본 문서는 추후 업데이트 예정입니다.",
  ...
  sections: [
    {
      ...
      content:
        "New Product는 현재 문서 온보딩 준비 중입니다. 제품 목적, 핵심 기능, 운영 범위에 대한 상세 내용은 추후 업데이트 예정입니다. 온보딩 완료 시 전체 매뉴얼이 자동으로 생성되어 배포됩니다.",
      ...
      sampleOutputs: {
        ja: "New Productは現在、文書オンボーディングの準備中です。製品目的・主要機能・運用範囲の詳細は追って更新予定です。オンボーディング完了後、完全なマニュアルが自動生成・配布されます。",
    ...
    },
    {
      ...
      intent: "초기 환경 구성 안내",
      content:
        "New Product의 초기 설정 절차는 추후 업데이트 예정입니다. 시스템 요구사항, 환경 설정, 권한 구성 방법은 온보딩 완료 후 본 섹션에 반영됩니다.",
      ...
      sampleOutputs: {
        ja: "New Productの初期設定手順は追って更新予定です。システム要件・環境設定・権限構成の方法は、オンボーディング完了後にこのセクションに反映されます。",
    ...
    },
    {
      ...
      intent: "매뉴얼 생성 규칙 설명",
      content:
        "New Product의 문서 생성 규칙은 추후 업데이트 예정입니다. 구조화 데이터 스키마, 섹션 구성, 언어별 출력 방식은 온보딩 완료 후 정의됩니다.",
      ...
      sampleOutputs: {
        ja: "New Productの文書生成ルールは追って更新予定です。構造化データスキーマ・セクション構成・言語別出力方式はオンボーディング完了後に定義されます。",
    ...
    },
    {
      ...
      content:
        "New Product의 운영 규칙 및 승인 체계는 추후 업데이트 예정입니다. 점검 주기, 에스컬레이션 정책, 배포 규칙은 온보딩 완료 후 본 섹션에 등록됩니다.",
      ...
      sampleOutputs: {
        ja: "New Productの運用ルールおよび承認体系は追って更新予定です。点検サイクル・エスカレーションポリシー・配布ルールはオンボーディング完了後に登録されます。",
    ...
    },
    {
      ...
      content:
        "New Product의 FAQ 및 검색 기능은 추후 업데이트 예정입니다. 자주 묻는 질문, 출처 표시 방식, AI 검색 연동 방법은 온보딩 완료 후 자동 생성됩니다.",
      ...
      sampleOutputs: {
        ja: "New ProductのFAQと検索機能は追って更新予定です。よくある質問・出典表示方法・AI検索連動方法はオンボーディング完了後に自動生成されます。",
  ...
  faqSeeds: [
    {
      question: "New Product 문서는 언제 제공되나요?",
      answer:
        "New Product 문서는 현재 온보딩 준비 중이며 추후 업데이트 예정입니다. 온보딩 완료 시 전체 매뉴얼이 자동으로 생성되어 배포됩니다."
    },
    {
      question: "New Product의 주요 기능은 무엇인가요?",
      answer:
        "New Product의 주요 기능 및 상세 사양은 추후 업데이트 예정입니다. 온보딩 담당자에게 문의해 주세요."
    },
    {
      question: "New Product 매뉴얼을 다운로드할 수 있나요?",
      answer:
        "다운로드 기능은 온보딩 완료 후 활성화될 예정입니다. 현재는 플레이스홀더 문서만 제공됩니다."
    },
    {
      question: "New Product의 접근 권한은 어떻게 설정하나요?",
      answer:
        "접근 권한 설정 방법은 추후 업데이트 예정입니다. 온보딩 완료 후 역할 기반 접근 제어(RBAC) 정책이 등록됩니다."
    },
    {
      question: "New Product 온보딩 담당자는 누구인가요?",
      answer:
